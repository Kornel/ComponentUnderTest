package org.kornel.testing.statement;
...
public final class ComponentUnderTestStatement extends Statement {
    ...
    private void injectMocks(final Object testClass) throws Exception {
    ...
    private void tryCreate(final Field componentUnderTest, final Object testClass) throws Exception {
